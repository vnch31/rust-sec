...
impl Module for DirectoryListingDisclosure {
    fn name(&self) -> String {
        "http_modules/directory_listing_disclosure".to_string()
    }

    fn description(&self) -> String {
        "Check if the target is exposing a directory listing".to_string()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_is_directory_listing() {
        ...
        let body4 = String::from("test test test test <test> <titl>Index</title> test");
